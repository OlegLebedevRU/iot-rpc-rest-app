...
| 🕸️ [**Leo4 Autonomous Mesh**](./docs/autonomous-mesh.md) | Автономная отказоустойчивая сеть из 3–5 (N) идентичных ARM64-копий платформы с реактивным оркестратором без состояния (stateless) |
