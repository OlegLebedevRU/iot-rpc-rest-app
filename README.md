...
| 🕸️ [**Leo4 Autonomous Mesh**](./docs/autonomous-mesh.md) | Автономная отказоустойчивая сеть из N идентичных ARM64-копий платформы (обычно 3–5) с реактивным оркестратором без состояния (stateless) |
