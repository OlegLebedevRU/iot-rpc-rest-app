...
>- Под капотом сервиса — PKI для устройств с использованием сертификатов, изолированные группы (организации), системная шина и очереди с приоритезацией, а также механизмы TTL.
