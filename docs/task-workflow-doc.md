...
>- Под капотом сервиса — PKI для устройств с использованием сертификатов, DI-изолированные пользователи и группы (организации), системная шина и очереди с приоритезацией, а также механизмы TTL
