...
- [Протокол асинхронных событий (event-protocol-mqtt.md)](https://github.com/OlegLebedevRU/iot-rpc-rest-app/blob/master/docs/event-protocol-mqtt.md) — Подробное описание топиков `evt`/`eva`, формата событий и тегов `3xx`
