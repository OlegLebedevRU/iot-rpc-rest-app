...
### 📋 Коды команд (method_code)

> 📖 Полный реестр кодов команд, форматов `payload.dt` и ответов `res` — см. [`method-codes-reference.md`](./method-codes-reference.md).
...
- [Справочник кодов команд method_code](./method-codes-reference.md)
