...
class DeviceProvisioning(Base):
    ...
    __tablename__: Any = "tb_device_provisionings"
    ...
    status: Mapped[str] = mapped_column(
        sa.String(32), nullable=False, default="requested", index=True
    )
    ...
    provisioning_metadata: Mapped[dict[str, Any]] = mapped_column(
    ...
    __table_args__ = (
        sa.Index(
            "ix_tb_device_provisionings_tenant_terminal", "tenant_id", "terminal_id"
        ),
    )
