...
class DevTaskPayload(Base):
    ...
    one_task_payload = relationship("DevTask", backref="task")
...
class DevTaskStatus(Base):
    ...
    one_task_status = relationship("DevTask", backref="player")
...
class DevTaskResult(Base):
    ...
    one_task_result = relationship("DevTask", backref="player")
